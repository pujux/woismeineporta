...
<title>${title} — Wo is meine Porta?</title>
...
main{text-align:center;padding:2rem;max-width:28rem}h1{font-size:1.5rem}a{color:#0369a1}
@media (prefers-color-scheme: dark){body{background:#020617;color:#e2e8f0}a{color:#38bdf8}}</style></head>
